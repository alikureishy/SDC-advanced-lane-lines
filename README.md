...
Here's an illustration of some transformations generated by the Thresholder (for another expression than the one shown above):
![Thresholding illustration](https://github.com/safdark/advanced-lane-lines/blob/master/docs/images/illustration1.png "Various thresholds being applied to an image")
