...
class ColorHistogram(object):
    def __init__(self, color_space='RGB', nbins=32, bins_range=(0, 256), channel=None):
    ...
    def extract(self, image):
        ...
        if self.__channel__ is None:
            ...
            hist_features = np.histogram(image[:,:,self.__channel__], bins=self.__nbins__, range=self.__bins_range__)[0]
