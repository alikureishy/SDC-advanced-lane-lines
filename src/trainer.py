...
if __name__ == '__main__':
    ...
    parser = argparse.ArgumentParser(description='Vehicle Detection Trainer')
    ...
    parser.add_argument('-t', dest='testratio', default=0.10, type=float, help='Percent of training data held aside for testing.')
